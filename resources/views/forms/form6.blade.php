<x-base-layout>
    ...
    <div class="text-center">
        <div class="mb-2">
            <textarea class="bg-black border border-white rounded w-64 px-2" placeholder="Please tell me a word about yourself." id="nameInput" name="human" oninput="enableSubmit()"></textarea>
        </div>
    ...
    <script>
        ...
        document.getElementById('submitButton').addEventListener('click', function(event) {
            if (this.classList.contains('button-disabled')) {
                ...
                window.location.href = "{{ route('form7') }}"; // Redirect if not disabled
            }
        });
    </script>
    </body>
